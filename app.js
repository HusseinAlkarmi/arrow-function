...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Multi-line arrow function:', multiLiner('hi'));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Hi from the old object function', oldObject(['hi', 'hi', 'are you there?']));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Hi from the new object function', newObject(['hi', 'hi', 'are you there?']));
...
let objLit = ()=> ({ key1: 'val1', key2: 'val2',key3: 'val3'});

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(objLit());


let sumProduct = (a, b)=> {let sum = a + b; let product = a * b; return [sum, product];};

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sumProduct(3, 9));


let alert = (name)=> {return `Hi, ${name}!`;};

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(alert('Allie'));


let Student = (name, age, town) =>{
  this.name = name;
  this.age = age;
  this.town = town;
